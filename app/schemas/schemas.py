...
class RelevanceAssessment(BaseModel):
    """
    Represents the semantic relevance assessment of a news article with respect to the user's news request.
    """
...
class DuplicateGroups(BaseModel):
    """
    Represents the group of duplicate article_ids identified among the news articles in the form of a list.
    """
...
class VerificationAssessment(BaseModel):
    """
    Represents the verification assessment of a news article_id basis the credibility.
    Also indicates whether the article should be retained after verification.
    """
    ...
    keep: bool = Field(
        description=(
            "Indicates whether the article should be retained after verification. "
            "Only articles with keep=True will proceed to downstream stages."
        )
    )
    reason: str = Field(
        description=(
            "Provide a concise explanation (maximum 1-2 sentences) describing why the article was considered credible or not."
        )
    )

class VerificationAssessmentCollection(BaseModel):
    """
    Represents the collection of verification assessments generated by the Verification Agent in the form of a list.
    """
