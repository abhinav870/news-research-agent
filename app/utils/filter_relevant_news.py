...
def filter_relevant_news(news_collection: NewsArticleCollection, assessment_collection: RelevanceAssessmentCollection) -> NewsArticleCollection:
    ...
    2) RelevanceAssessmentCollection contains the article_ids, topic_relation, relevance_score and keep (True or False) of the news articles that are relevant to the user's request.
